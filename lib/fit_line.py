...
def vizualize1(binary_warped, ret, save_file=None):
    """
...
def vizualize2(binary_warped, ret, save_file=None):
    """
...
def calculate_curve(left_lane_inds, right_lane_inds, nonzerox, nonzeroy):
    """
...
def calculate_vehicle_offset(undist, left_fit, right_fit):
    """
...
def final_vizualzation(undist, left_fit, right_fit, m_inv, left_curve, right_curve, vehicle_offset):
    """
